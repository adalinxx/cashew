...
2. `Header+store.swift` unresolved-owned-node and membership-aware deduplication behavior.
3. `Node+store.swift` ordinary-owned versus nested-Volume traversal.
